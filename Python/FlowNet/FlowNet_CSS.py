...
class LoadInitializer(Initializer):
    ...
    def __init__(self, dtype=tf.float32, name='', trainable=True):
        ...
        self.filename = '/home/klein/U/extracted_weights/flownet_css/' + name + '.npy'

        if not trainable:  # load own pretrained fixed weights
            self.filename = '/home/klein/U/extracted_weights/flownet_cs_kitti/' + name + '.npy'
...
def model_fn(features, labels, mode, params):
    ...
    with tf.variable_scope('FlowNet_C'):
        ...
        conv_b_1 = conv(image_b, filters=64, kernel_size=7, strides=2, fr=firstrun, trainable=False, reuse=True, name='FlowNet_C_conv1')
        conv_b_2 = conv(conv_b_1, filters=128, kernel_size=5, strides=2, fr=firstrun, trainable=False, reuse=True, name='FlowNet_C_conv2')
        conv_b_3 = conv(conv_b_2, filters=256, kernel_size=5, strides=2, fr=firstrun, trainable=False, reuse=True, name='FlowNet_C_conv3')
        ...
        # refinement
        predict_6 = conv(conv6_1, filters=2, kernel_size=3, activation=None, fr=firstrun, trainable=False, name='FlowNet_C_predict_flow6')
        ...
        predict_5 = conv(concat5, filters=2, kernel_size=3, activation=None, fr=firstrun, trainable=False, name='FlowNet_C_predict_flow5')
        ...
        predict_4 = conv(concat4, filters=2, kernel_size=3, activation=None, fr=firstrun, trainable=False, name='FlowNet_C_predict_flow4')
        ...
        predict_3 = conv(concat3, filters=2, kernel_size=3, activation=None, fr=firstrun, trainable=False, name='FlowNet_C_predict_flow3')
        ...
        predict_2 = conv(concat2, filters=3, kernel_size=3, activation=None, fr=firstrun, trainable=False, name='FlowNet_C_predict_2')  # no pretrained weights available because we want 3d-flow
    ...
    with tf.variable_scope('FlowNet_S_fixed'):
        ...
        upsample_6to5 = deconv(predict_6, filters=2, kernel_size=4, strides=2, activation=None, fr=firstrun, trainable=False, name='FlowNet_S_upsample_flow6to5')
        ...
        upsample_5to4 = deconv(predict_5, filters=2, kernel_size=4, strides=2, activation=None, fr=firstrun, trainable=False, name='FlowNet_S_upsample_flow5to4')
        ...
        upsample_4to3 = deconv(predict_4, filters=2, kernel_size=4, strides=2, activation=None, fr=firstrun, trainable=False, name='FlowNet_S_upsample_flow4to3')
        ...
        upsample_3to2 = deconv(predict_3, filters=2, kernel_size=4, strides=2, activation=None, fr=firstrun, trainable=False, name='FlowNet_S_upsample_flow3to2')
        x = tf.concat([x_conv2, x, upsample_3to2], axis=3, name='concat_4')

        predict_2 = conv(x, filters=3, kernel_size=3, activation=None, fr=firstrun, trainable=False, name='FlowNet_S_predict_2')
        x = tf.image.resize_bilinear(predict_2, [64, 1024], align_corners=True)
