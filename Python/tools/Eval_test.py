...
def main(args):
    groundtruth_file = '/home/klein/U/gridmapsfull/eval/kitti00/gridmaps.csv'
    in_folder = '/home/klein/U/inference/gridmaps_seq_0'
    number_of_run = 0
    ...
    with open('/home/klein/U/gridmapsFlow_old/train/kitti00/features.csv', 'r') as f:
