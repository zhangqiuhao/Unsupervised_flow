        ...
        with open(exclude_list_path) as f:
            for line in f:
                ...
                if line.split(' ')[0].endswith('_10'):
                    ...
                    exclude_from_seq(day_name, seq_str, image, 'image_00') #added
                    exclude_from_seq(day_name, seq_str, image, 'image_01') #added
                    exclude_from_seq(day_name, seq_str, image, 'image_02') #added
                    exclude_from_seq(day_name, seq_str, image, 'image_03') #added
                    exclude_from_seq(day_name, seq_str, image, 'image_04') #added
                    exclude_from_seq(day_name, seq_str, image, 'image_05') #added
                    exclude_from_seq(day_name, seq_str, image, 'image_06') #added
                    exclude_from_seq(day_name, seq_str, image, 'image_07') #added
    if remove:
    ...
    def get_raw_dirs(self):
       ...
       for date in dates:
           ...
           for extract in extracts:
               ...
               image_00_folder = os.path.join(extract_path, 'image_00/data') #added
               image_01_folder = os.path.join(extract_path, 'image_01/data') #added
               image_02_folder = os.path.join(extract_path, 'image_02/data') #added
               image_03_folder = os.path.join(extract_path, 'image_03/data') #added
               image_04_folder = os.path.join(extract_path, 'image_04/data') #added
               image_05_folder = os.path.join(extract_path, 'image_05/data') #added
               image_06_folder = os.path.join(extract_path, 'image_06/data') #added
               image_07_folder = os.path.join(extract_path, 'image_07/data') #added
